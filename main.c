...
/**
 * free_vglo - To free the global variables
 *
 * Return: no return
 */
void free_vglo(void)
...
/**
 * start_vglo - To initialize the global variables
 *
...
/**
 * check_input - To check if the file exists and if the file can
 * be opened
 *
